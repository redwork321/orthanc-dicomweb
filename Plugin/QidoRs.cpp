...
namespace
{
  ...
  public:
                       ...
                       QueryLevel level) const
    {
      ...
      result[Format(OrthancPlugins::DICOM_TAG_RETRIEVE_URL)] = tmp;
    }
  };
}
                         ...
                         QueryLevel level)
{
  ...
  {
    Json::Value tags;
    if (OrthancPlugins::RestApiGetJson(tags, context_, "/instances/" + *it + "/tags"))
    {
